    ...
    if (type !== "MATERIAL") {
        return (
            <div className="px-4 py-6 sm:px-6 lg:px-12 lg:py-10">
                <div className="rounded-2xl border border-(--color-border) bg-white p-8 text-center shadow-sm">
                    <h1 className="text-xl font-semibold text-slate-800">
                        Loại hàng không hợp lệ
                    </h1>

                    <p className="mt-2 text-sm text-slate-500">
                        Trang này hiện chỉ hỗ trợ tạo phiếu xuất nguyên vật liệu.
                    </p>

                    <button
                        type="button"
                        onClick={() => navigate("/receipts-issues")}
                        className="mt-6 rounded-xl bg-(--color-primary) px-5 py-3 font-medium text-white transition hover:bg-(--color-primary-hover)"
                    >
                        Quay lại
                    </button>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                            Tạo thông tin phiếu xuất nguyên vật liệu trước khi thêm các mặt hàng.
                        </p>
                    </div>
                </div>
