...
function UserPage() {
    ...
    const { sortField, sortDir, onSort, sortParam } = useSort("username", "asc");
    ...
    return (
        <div>
            ...
            {confirmUser && (
                <ConfirmDialog
                    title={confirmUser.enabled ? "Khóa người dùng?" : "Mở khóa người dùng?"}
                    message={
                        confirmUser.enabled
                            ? "Người dùng sẽ không thể đăng nhập vào hệ thống."
                            : "Người dùng sẽ có thể đăng nhập lại vào hệ thống."
                    }
                    confirmText={confirmUser.enabled ? "Khóa" : "Mở khóa"}
